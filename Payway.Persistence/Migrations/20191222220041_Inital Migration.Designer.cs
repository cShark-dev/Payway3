...
namespace Payway.Persistence.Migrations
{
    ...
    [Migration("20191222220041_Inital Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Payway.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Payway.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Payway.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Payway.Entity.PaymentRecord", b =>
                {
                    b.HasOne("Payway.Entity.Employee", "Employee")
                        .WithMany("PaymentRecords")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Payway.Entity.TaxYear", "TaxYear")
                        .WithMany()
