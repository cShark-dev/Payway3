...
namespace Payway.Models
{
    ...
    {
        //For the properties go to the entity layer and copy the properties of PaymentRecord.cs
        ...
        public decimal ContractualHours { get; set; } = 144m;           //Initialise contractual hours and assume it's 144 hours for everybody         
